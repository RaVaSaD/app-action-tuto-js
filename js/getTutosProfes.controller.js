(function() {
    ...
    angular
        .module('actionTuto')
        .controller('GetTutosProfesController', function($scope, $http, $rootScope, $location, $route){
			...
			function init(){			        
			    ...
			    if ( $rootScope.tipoUsuario == 'profesor'){
			        $http.post('php/apiTutoTeacher.php', { usuario : $rootScope.idUsuario })
			...
			$scope.editarTuto = function (idTuto){
				$location.url("/edittutoprofes/" + idTuto);
			}
